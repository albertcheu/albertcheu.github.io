...
function brushed() {
  ...
  var point1 = (s[0] + margin.left).toString() + ",130";
  var point2 = (margin.left).toString() + ",90"; //fixed
  var point3 = (margin.left + t.width).toString() + ",90" ; //fixed
  var point4 = (s[1] + margin.left).toString() + ",130";
